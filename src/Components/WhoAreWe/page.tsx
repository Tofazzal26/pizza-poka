...
const WhoAreWe = () => {
  return (
    <div>
      <div className="flex lg:flex-row flex-col justify-center gap-4 lg:gap-8 items-center my-10 lg:my-20">
        <div>
          <Image
            src="/who.jpg"
            width={255}
        ...
        <div className="customShadow text-center px-4 lg:px-8 py-10 lg:py-20">
          <h2 className="text-lg lg:text-[24px] text-[#89b758] uppercase">
            who are we
          </h2>
          <h2 className="text-2xl lg:text-[48px] font-black lg:w-[480px] lg:leading-[50px]">
            Best burger ideas & traditions from the whole world
          </h2>
          <p className="text-sm lg:text-base text-[#7a7a7a] lg:w-[450px] lg:mt-10">
